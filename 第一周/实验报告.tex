...
\begin{figure}[htbp]
  ...
  \resizebox{0.78\textwidth}{!}{%
    \vbox{\offinterlineskip
      \hbox{\includegraphics[trim=0 345bp 0 0,clip]{课上/q01/分布命令1.png}}%
      \hbox{\includegraphics[trim=0 0 167.6bp 0,clip]{课上/q01/分布命令2.png}}%
      \hbox{\includegraphics{课上/q01/分步命令3.png}}%
    }%
  }
...
\begin{figure}[p]
  ...
  \resizebox{!}{0.88\textheight}{%
    \vbox{\offinterlineskip
      \hbox{\includegraphics{课后/shell-notes/1.png}}%
      \hbox{\includegraphics{课后/shell-notes/2.png}}%
    }%
  }
